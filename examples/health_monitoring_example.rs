use rust_rabbit::{
    config::HealthCheckConfig, health::HealthCheckConfigExt, RabbitConfig, RustRabbit,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for i in 0..20 {
        ...
        info!(
            "Health check {}: healthy={}, operational={}",
            i + 1,
            is_healthy,
            is_operational
        );
    ...
    match health_checker
        .wait_for_healthy(Some(Duration::from_secs(10)))
        .await
    {
